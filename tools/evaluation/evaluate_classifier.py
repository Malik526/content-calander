...
from content_automation.config import CONTENT_TYPES, REPO_ROOT

# Milestone 3.0: this script moved from repo root to tools/evaluation/ —
# REPO_ROOT (not a locally recomputed Path(__file__).with_name(...)) keeps
# this pointing at the real repo-root evaluation/ dataset directory.
DEFAULT_DATASET_DIR = REPO_ROOT / "evaluation"
