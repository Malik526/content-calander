...
# Milestone 3.0: this script moved from repo root to cli/ — REPO_ROOT
# (config.py's single source of truth, not a locally recomputed
# Path(__file__).resolve().parent) keeps this pointing at the actual
# repository root regardless of where the script itself lives.
_NEW_ROOT = REPO_ROOT
