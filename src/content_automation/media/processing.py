...
Run command (Milestone 3.0: thin CLI entry point at cli/process_content.py):
...
Dependencies:
  content_automation.media.inspection, content_automation.media.transcription,
  content_automation.media.classification, content_automation.media.caption,
  content_automation.persistence.content_store,
  content_automation.scheduling.slot_matcher, config.py
"""
