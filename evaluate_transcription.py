...
DEFAULT_MANIFEST = Path(__file__).with_name("evaluation") / "video_pipeline" / "metadata.jsonl"
DEFAULT_RESULTS = Path(__file__).with_name("evaluation") / "video_pipeline" / "results.jsonl"
SNIPPET_LENGTH = 120
